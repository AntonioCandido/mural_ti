    ...
    <div className="container mx-auto px-6 py-12 fade-in">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-20">
          <div className="lg:col-span-2 bg-white p-12 md:p-16 rounded-[4rem] border border-slate-100 shadow-2xl -translate-y-1">
            ...
            <div className="prose prose-lg max-w-none text-slate-600 font-medium space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mt-12">
                <div className="p-8 bg-slate-50 rounded-3xl border border-slate-100 shadow-xl">
                ...
                <div className="p-8 bg-estacio-navy text-white rounded-3xl shadow-xl shadow-estacio-navy/20 relative overflow-hidden">
                  <div className="absolute inset-0 bg-white/5"></div>
                  <h4 className="relative z-10 font-black text-estacio-cyan text-xs uppercase tracking-widest mb-4">Carreira Global</h4>
                  <p className="relative z-10 text-sm leading-relaxed opacity-90 italic">Vagas remotas nos EUA/Europa podem pagar de $4k a $12k dólares por mês, multiplicando seu poder de compra.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-8">
            <div className="bg-estacio-cyan p-10 rounded-[3.5rem] text-estacio-navy shadow-2xl -translate-y-1 border border-white/20 relative overflow-hidden">
            ...
            <div className="bg-slate-900 p-10 rounded-[3.5rem] text-white shadow-2xl -translate-y-1 border border-white/10 relative overflow-hidden">
              <div className="absolute inset-0 bg-white/5"></div>
              <Zap size={40} className="mb-6 text-estacio-amber relative z-10" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {PORTAIS.map((link, i) => (
              <a 
                ...
                href={link.url} 
                target="_blank" 
                className={`relative p-10 rounded-[3rem] border border-white/20 shadow-2xl -translate-y-1 transition-all ${link.color} text-white`}
              >
                <div className="absolute inset-0 bg-white/10"></div>
                <h4 className="relative z-10 font-black italic uppercase mb-4 text-white text-xl">{link.title}</h4>
                <p className={`relative z-10 text-xs font-bold leading-relaxed ${link.color === 'bg-estacio-cyan' ? 'text-estacio-navy' : 'text-white/80'}`}>{link.desc}</p>
                <div className="relative z-10 mt-8 flex items-center gap-2 text-[10px] font-black uppercase tracking-widest opacity-100">
