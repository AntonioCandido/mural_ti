...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col relative selection:bg-estacio-cyan/30">
      ...
      <div className={`fixed top-[120px] left-0 right-0 z-[45] transition-all duration-500 transform ${isOffline ? 'translate-y-0 opacity-100' : '-translate-y-full opacity-0 pointer-events-none'}`}>
      ...
      <main className="flex-grow pt-32 pb-4 overflow-x-hidden">
        <Suspense fallback={
